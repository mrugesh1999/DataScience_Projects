...
# Setup client
finnhub_client = finnhub.Client(api_key="cjva4ahr01qlmkvd0nl0cjva4ahr01qlmkvd0nlg")
...
if __name__ == "__main__":
    ...
    ws = websocket.WebSocketApp("wss://ws.finnhub.io?token=cjva4ahr01qlmkvd0nl0cjva4ahr01qlmkvd0nlg",
